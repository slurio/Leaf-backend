...
CountryFact.create(country: "USA", description: "The United States is a globally competitive manufacturer and exporter of textile raw materials, fabrics, yarns, apparel, home furnishing, and other textile products. The United States is the 8th largest textile exporter. The strength of US textile lies in Non-Woven, Specialty and Industrial Fabrics, Medical Textiles and Protective Apparel.")
...
CountryFact.create(country: "China", description: "The textile industry of China is the largest manufacturer and exporter in the world with an export turnover of $266.41 Billion. The factors driving the industry in China are low-cost production, raw material quality, industrial structure,  and modern high-tech machinery. The output volume of China textile industry accounts for more than half of the global market.")
...
FiberFact.create(name: "Viscose", description: "The European term for rayon.", care_instructions: "A highly absorbent fabric, relatively inelastic and therefore very delicate especially when wet. This is why we recommend you hand wash, with cold or lukewarm water (maximum 20° C) rather than machine wash.")
